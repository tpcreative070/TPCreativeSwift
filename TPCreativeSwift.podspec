...
Pod::Spec.new do |s|
  ...
  s.description  = 'TPCreativeSwift is small collections which libraries Popular'
  ...
  s.source       = { :git => "https://github.com/tpcreative070/TPCreativeSwift.git", :tag => "#{s.version}" }
